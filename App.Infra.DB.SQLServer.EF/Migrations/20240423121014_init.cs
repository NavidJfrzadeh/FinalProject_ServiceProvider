        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gender = table.Column<int>(type: "int", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
                    PhoneNumberBackUp = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "Id", "Email", "FistName", "LastName", "Password" },
                values: new object[] { 1, "navid@gmail.com", "Navid", "Jafarzadeh", "9" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "تاسیسات ساختمان" },
                    { 3, "وسایل نقلیه" },
                    { 4, "اسباب کشی و باربری" },
                    { 5, "لوازم خانگی" },
                    { 7, "خدمان اداری" },
                    { 8, "بهداشت و نظافت" },
                    { 9, "دیجیتال و نرم افزار" }
                });
